...
![MissUnit structure](../figure/ICache/missUnit.png){#fig:icache-missunit-structure}

## MSHR Management {#sec:icache-missunit-mshr}
...
## Request Enqueue {#sec:icache-missunit-enqueue}
...
### Duplicate Request Filtering {#sec:icache-missunit-filter-duplicate}
...
### Victim Selection {#sec:icache-missunit-victim}
...
### Exception Handling {#sec:icache-missunit-exception}
